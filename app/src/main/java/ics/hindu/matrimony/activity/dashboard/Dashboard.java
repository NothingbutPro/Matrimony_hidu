...
import ics.hindu.matrimony.BuildConfig;
...
import ics.hindu.matrimony.activity.myprofile.Profile;
import ics.hindu.matrimony.activity.subscription.MemberShipActivity;
import ics.hindu.matrimony.database.FriendDB;
import ics.hindu.matrimony.fragment.Chats;
import ics.hindu.matrimony.fragment.EventsFrag;
import ics.hindu.matrimony.fragment.HomeFrag;
import ics.hindu.matrimony.fragment.InterestFrag;
import ics.hindu.matrimony.fragment.SearchFrag;
import ics.hindu.matrimony.fragment.AboutFrag;
import ics.hindu.matrimony.fragment.SettingsFrag;
import ics.hindu.matrimony.fragment.ShortlistedFrag;
import ics.hindu.matrimony.fragment.VisitorsFrag;
...
import ics.hindu.matrimony.utils.CustomTypeFaceSpan;
...
import ics.hindu.matrimony.view.FontCache;
            ...
            public void onClick(View view) {
                if (prefrence.getBooleanValue(Consts.IS_SUBSCRIBE)) {
                   ...
                   startActivity(new Intent(mContext, MemberShipActivity.class));
                    ...
                    spinnerDialog = new SpinnerDialog(Dashboard.this);
