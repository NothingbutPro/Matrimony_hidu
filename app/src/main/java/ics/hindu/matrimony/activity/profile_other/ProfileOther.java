...
public class ProfileOther extends AppCompatActivity implements View.OnClickListener {
    ...
    private LinearLayout lllContact,llKundly;
...
////***************static design******************************************************
        lllContact=findViewById(R.id.llContact);
        llKundly=findViewById(R.id.llKundly);
        lllContact.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                spinnerDialog = new SpinnerDialog(ProfileOther.this);
                spinnerDialog.showConatactDialog();
            }
        });

        llKundly.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                spinnerDialog = new SpinnerDialog(ProfileOther.this);
                spinnerDialog.showConatactDialog();
