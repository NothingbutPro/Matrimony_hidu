...
public class HomeFrag extends Fragment implements View.OnClickListener {
    ...
    private View view;
    private RelativeLayout tab_match, tab_join,tab_search;
    ...
    private SearchFrag searchFrag = new SearchFrag();
    ...
    public void setUiAction(View v) {
        ...
        tab_search = v.findViewById(R.id.tab_search);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tab_join:
                ...
                setSelected(false, true);
                fragmentManager.beginTransaction().replace(R.id.container, searchFrag).commit();
                break;
        }
    }
