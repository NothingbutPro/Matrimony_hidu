...
public class ProfileFor extends Fragment implements AdapterProfileFor.UpdateDataClickListener {
    ...
    public void setUIAction(View view) {
        ...
        profileforList.add(new ProfileForDTO("7",getResources().getString(R.string.client)));
        profileforList.add(new ProfileForDTO("8",getResources().getString(R.string.friend)));
