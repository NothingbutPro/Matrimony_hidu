...
public class MatchesFrag extends Fragment {
    ...
    LinearLayout llContact,llKundly;
    ...
    public void setUiAction(View view) {
        ...
        rlClick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), ProfileOther.class);
